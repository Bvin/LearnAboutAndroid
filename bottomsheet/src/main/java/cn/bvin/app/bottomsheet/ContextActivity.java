...
public class ContextActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewGroup frame = (ViewGroup) findViewById(R.id.activity_context);
        TextView tv = new TextView(ContextActivity.this);
        CoordinatorLayout.LayoutParams lp = new CoordinatorLayout.LayoutParams(CoordinatorLayout.LayoutParams.WRAP_CONTENT,CoordinatorLayout.LayoutParams.MATCH_PARENT);
        tv.setLayoutParams(lp);
        tv.setText("Ggh啊护身复活ipaPI");
        tv.setTextColor(ResourcesFinder.getColor(getResources(),R.color.colorPrimaryDark));
        tv.setBackgroundColor(ResourcesFinder.getColor(getResources(),R.color.colorAccent));
        frame.addView(tv,0);
