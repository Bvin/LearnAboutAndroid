 ...
 */
public class OldSwipeRefreshLayout extends ViewGroup {
     ...
     * @param context
     */
    public OldSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public OldSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
