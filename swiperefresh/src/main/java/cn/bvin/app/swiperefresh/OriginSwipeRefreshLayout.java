...
/**
 * Created by bvin on 2016/12/7.
 */

public class OriginSwipeRefreshLayout extends ViewGroup {
    ...
    public OriginSwipeRefreshLayout(Context context) {
        this(context, null);
    }

    public OriginSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
